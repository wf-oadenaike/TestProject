CREATE PROCEDURE [Scheduler].[usp_CreateTCAArchiveSlackScheduleItem]
...
BEGIN TRY
	...
	DECLARE	@strProcedureName VARCHAR(100)	= 'Scheduler.usp_CreateTCAArchiveSlackScheduleItem',
	...
	SET @FlowId = ( SELECT FlowId
				    ...
				    WHERE FlowName='TCA - Archived Slack Channels'
					);
...
*/
	...
	USING (
			SELECT @FlowId as FlowId,
				   ...
				   'TCA Archived Slack Channels' as LaunchRef,
					1 as IsActive
		 ) Src
