CREATE PROCEDURE [Scheduler].[usp_CreateDvdForecastingScheduleItem]
...
BEGIN TRY
	...
	DECLARE	@strProcedureName VARCHAR(100)	= 'Scheduler.usp_CreateDvdForecastingScheduleItem',
	...
	SET @FlowId = ( SELECT FlowId
				    ...
				    WHERE FlowName='Dividend Forecasting - Scheduler Flow'
					);
	...
	USING (
			SELECT @FlowId as FlowId,
				   ...
				   'Dividend Forecasting' as LaunchRef,
					1 as IsActive
		 ) Src
