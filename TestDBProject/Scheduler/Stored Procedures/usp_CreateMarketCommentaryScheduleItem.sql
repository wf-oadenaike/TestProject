CREATE PROCEDURE [Scheduler].[usp_CreateMarketCommentaryScheduleItem]
...
BEGIN TRY
	...
	DECLARE	@strProcedureName VARCHAR(100)	= 'Scheduler.usp_CreateMarketCommentaryScheduleItem',
	...
	SET @FlowId = ( SELECT FlowId
				    ...
				    WHERE FlowName='Market Commentary'
					);
	...
	USING (
			SELECT @FlowId as FlowId,
				   ...
				   'Market Commentary' as LaunchRef,
					1 as IsActive
		 ) Src
