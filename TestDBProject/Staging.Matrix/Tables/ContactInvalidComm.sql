CREATE TABLE [Staging.Matrix].[ContactInvalidComm] (
    ...
    CONSTRAINT [PK__staging_Matrix_ContactInvalidComm] PRIMARY KEY CLUSTERED ([SALESFORCE_CONTACT_ID] ASC, [FILE_DATE] ASC) WITH (FILLFACTOR = 90)
);
