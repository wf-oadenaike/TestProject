CREATE TABLE [Staging.Matrix].[AccountInvalidComm] (
    ...
    CONSTRAINT [PK__Staging_Matrix_AccountInvalidComm] PRIMARY KEY CLUSTERED ([SALESFORCE_ACCOUNT_ID] ASC, [FILE_DATE] ASC) WITH (FILLFACTOR = 90)
);
