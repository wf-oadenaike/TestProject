CREATE TABLE [dbo].[T_DUMMY_MG_SEC_ANALYTIC] (
    ...
    [CADIS_SYSTEM_INSERTED]            DATETIME        CONSTRAINT [DF__T_DUMMY_M__CADIS__0E37B7B1] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_UPDATED]             DATETIME        CONSTRAINT [DF__T_DUMMY_M__CADIS__0F2BDBEA] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_CHANGEDBY]           NVARCHAR (50)   CONSTRAINT [DF__T_DUMMY_M__CADIS__10200023] DEFAULT ('UNKNOWN') NULL,
    [CADIS_SYSTEM_PRIORITY]            INT             CONSTRAINT [DF__T_DUMMY_M__CADIS__1114245C] DEFAULT ((1)) NULL,
    [CADIS_SYSTEM_TIMESTAMP]           ROWVERSION      NOT NULL,
    CONSTRAINT [PK__T_DUMMY___B157E8F24B26C949] PRIMARY KEY CLUSTERED ([EDM_SEC_ID] ASC) WITH (FILLFACTOR = 90)
);
