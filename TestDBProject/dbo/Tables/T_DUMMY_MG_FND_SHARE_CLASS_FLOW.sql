CREATE TABLE [dbo].[T_DUMMY_MG_FND_SHARE_CLASS_FLOW] (
    ...
    [CADIS_SYSTEM_INSERTED]     DATETIME        CONSTRAINT [DF__T_DUMMY_M__CADIS__0CD97F24] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_UPDATED]      DATETIME        CONSTRAINT [DF__T_DUMMY_M__CADIS__0DCDA35D] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_CHANGEDBY]    NVARCHAR (50)   CONSTRAINT [DF__T_DUMMY_M__CADIS__0EC1C796] DEFAULT ('UNKNOWN') NULL,
    [CADIS_SYSTEM_PRIORITY]     INT             CONSTRAINT [DF__T_DUMMY_M__CADIS__0FB5EBCF] DEFAULT ((1)) NULL,
    [CADIS_SYSTEM_LASTMODIFIED] DATETIME        CONSTRAINT [DF__T_DUMMY_M__CADIS__10AA1008] DEFAULT (getdate()) NULL,
    CONSTRAINT [PK__T_DUMMY___5128527D09A18844] PRIMARY KEY CLUSTERED ([VALUATION_POINT_DATE] ASC, [EXTERNAL_FUND_CODE] ASC, [FUND_REFERENCE] ASC) WITH (FILLFACTOR = 90)
);
