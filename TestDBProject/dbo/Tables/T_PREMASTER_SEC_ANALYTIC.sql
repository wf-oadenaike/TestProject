CREATE TABLE [dbo].[T_PREMASTER_SEC_ANALYTIC] (
    ...
    [CADIS_SYSTEM_INSERTED]            DATETIME        CONSTRAINT [DF__T_PREMAST__CADIS__7D7A3B95] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_UPDATED]             DATETIME        CONSTRAINT [DF__T_PREMAST__CADIS__7E6E5FCE] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_CHANGEDBY]           NVARCHAR (50)   CONSTRAINT [DF__T_PREMAST__CADIS__7F628407] DEFAULT ('UNKNOWN') NULL,
    [CADIS_SYSTEM_PRIORITY]            INT             CONSTRAINT [DF__T_PREMAST__CADIS__0056A840] DEFAULT ((1)) NULL,
    [CADIS_SYSTEM_LASTMODIFIED]        DATETIME        CONSTRAINT [DF__T_PREMAST__CADIS__014ACC79] DEFAULT (getdate()) NULL,
    CONSTRAINT [PK__T_PREMAS__B157E8F2E5621B48] PRIMARY KEY CLUSTERED ([EDM_SEC_ID] ASC) WITH (FILLFACTOR = 90)
);
