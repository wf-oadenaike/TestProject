CREATE TABLE [dbo].[T_PREMASTER_PTY] (
    ...
    [CADIS_SYSTEM_INSERTED]      DATETIME        CONSTRAINT [DF__T_PREMAST__CADIS__42701B0E] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_UPDATED]       DATETIME        CONSTRAINT [DF__T_PREMAST__CADIS__43643F47] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_CHANGEDBY]     NVARCHAR (50)   CONSTRAINT [DF__T_PREMAST__CADIS__44586380] DEFAULT ('UNKNOWN') NULL,
    [CADIS_SYSTEM_PRIORITY]      INT             CONSTRAINT [DF__T_PREMAST__CADIS__454C87B9] DEFAULT ((1)) NULL,
    [CADIS_SYSTEM_LASTMODIFIED]  DATETIME        CONSTRAINT [DF__T_PREMAST__CADIS__4640ABF2] DEFAULT (getdate()) NULL,
    CONSTRAINT [PK__T_PREMAS__F95823A920B38614] PRIMARY KEY CLUSTERED ([EDM_PTY_ID] ASC) WITH (FILLFACTOR = 90)
);
