CREATE TABLE [dbo].[T_MATRIX_REREGISTRATION] (
    ...
    [CADIS_SYSTEM_INSERTED]            DATETIME       CONSTRAINT [DF_T_MATRIX_REREGISTRATION_CSI] DEFAULT (getdate()) NOT NULL,
    [CADIS_SYSTEM_UPDATED]             DATETIME       CONSTRAINT [DF_T_MATRIX_REREGISTRATION_CSU] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_CHANGEDBY]           VARCHAR (50)   CONSTRAINT [DF_T_MATRIX_REREGISTRATION_CSCB] DEFAULT ('UNKNOWN') NULL,
    [CADIS_SYSTEM_PRIORITY]            INT            CONSTRAINT [DF_T_MATRIX_REREGISTRATION_CSP] DEFAULT ((1)) NULL,
    [CADIS_SYSTEM_TIMESTAMP]           ROWVERSION     NOT NULL,
    [CADIS_SYSTEM_LASTMODIFIED]        DATETIME       CONSTRAINT [DF_T_MATRIX_REREGISTRATION_CSL] DEFAULT (getdate()) NULL,
    CONSTRAINT [PK__T_MATRIX_REREGISTRATION] PRIMARY KEY CLUSTERED ([SALESFORCE_ACCOUNT_ID] ASC, [MX_MATRIX_ACCOUNT_SIV_ID] ASC, [AS_AT_DATE] ASC) WITH (FILLFACTOR = 90)
);
