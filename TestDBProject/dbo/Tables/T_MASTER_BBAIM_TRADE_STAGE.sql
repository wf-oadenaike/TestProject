CREATE TABLE [dbo].[T_MASTER_BBAIM_TRADE_STAGE] (
    [TraderAccountName]                     NVARCHAR (MAX) NULL,
    [TransactionNumber]                     NVARCHAR (MAX) NULL,
    [CADIS_BATCH_ID]                        INT            NULL,
    [CADIS_MSG_ID]                          INT            CONSTRAINT [DF__T_MASTER___CADIS__37A93F2F] DEFAULT ((1)) NULL,
    ...
    [CADIS_SYSTEM_INSERTED]                 DATETIME       CONSTRAINT [DF__T_MASTER___CADIS__389D6368] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_UPDATED]                  DATETIME       CONSTRAINT [DF__T_MASTER___CADIS__399187A1] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_CHANGEDBY]                NVARCHAR (50)  CONSTRAINT [DF__T_MASTER___CADIS__3A85ABDA] DEFAULT ('UNKNOWN') NULL,
    [CADIS_SYSTEM_PRIORITY]                 INT            CONSTRAINT [DF__T_MASTER___CADIS__3B79D013] DEFAULT ((1)) NULL,
    [CADIS_SYSTEM_LASTMODIFIED]             DATETIME       CONSTRAINT [DF__T_MASTER___CADIS__3C6DF44C] DEFAULT (getdate()) NULL,
