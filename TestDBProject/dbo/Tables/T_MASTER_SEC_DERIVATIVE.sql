CREATE TABLE [dbo].[T_MASTER_SEC_DERIVATIVE] (
    ...
    [CADIS_SYSTEM_LASTMODIFIED] DATETIME        CONSTRAINT [DF__T_MASTER___CADIS__791F9ACC] DEFAULT (getdate()) NULL,
    CONSTRAINT [PK__T_MASTER__B157E8F2B127969F] PRIMARY KEY CLUSTERED ([EDM_SEC_ID] ASC) WITH (FILLFACTOR = 90)
);
