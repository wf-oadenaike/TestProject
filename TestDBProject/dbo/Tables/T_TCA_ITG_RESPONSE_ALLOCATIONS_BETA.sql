CREATE TABLE [dbo].[T_TCA_ITG_RESPONSE_ALLOCATIONS_BETA] (
    ...
    CONSTRAINT [pk_T_TCA_ITG_RESPONSE_ALLOCATIONS_NETA] PRIMARY KEY CLUSTERED ([ORDERID] ASC, [TRADE_DATE_TIME] ASC, [ACCOUNT] ASC, [TRADE_SHARES] ASC) WITH (FILLFACTOR = 80)
);
