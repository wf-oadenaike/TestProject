CREATE TABLE [dbo].[T_TCA_ITG_RESPONSE_EXECUTIONS] (
    ...
    [EXEC_SEQ_NUMBER]                      INT              NOT NULL,
    [SPREADCAPTURE]                        DECIMAL (24, 10) NULL,
    [BROKERVENUE]                          VARCHAR (15)     NULL,
    [CADIS_SYSTEM_INSERTED]                DATETIME         DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_UPDATED]                 DATETIME         DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_CHANGEDBY]               NVARCHAR (50)    DEFAULT ('UNKNOWN') NULL,
    PRIMARY KEY CLUSTERED ([ORDERID] ASC, [TRADE_DATE_TIME] ASC, [EXEC_SEQ_NUMBER] ASC) WITH (FILLFACTOR = 90)
);
