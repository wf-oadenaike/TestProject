CREATE TABLE [dbo].[T_MASTER_NET_FUND_FLOW] (
    ...
    [CADIS_SYSTEM_INSERTED]                         DATETIME        CONSTRAINT [DF__T_MASTER___CADIS__48F7BF75] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_UPDATED]                          DATETIME        CONSTRAINT [DF__T_MASTER___CADIS__49EBE3AE] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_CHANGEDBY]                        NVARCHAR (50)   CONSTRAINT [DF__T_MASTER___CADIS__4AE007E7] DEFAULT ('UNKNOWN') NULL,
    [CADIS_SYSTEM_PRIORITY]                         INT             CONSTRAINT [DF__T_MASTER___CADIS__4BD42C20] DEFAULT ((1)) NULL,
    [CADIS_SYSTEM_LASTMODIFIED]                     DATETIME        CONSTRAINT [DF__T_MASTER___CADIS__4CC85059] DEFAULT (getdate()) NULL,
    CONSTRAINT [PK__T_MASTER__46233BEE2F70F090] PRIMARY KEY CLUSTERED ([ACCOUNT_NUMBER] ASC, [TNARRLONG] ASC, [NET_AMOUNT__BASE] ASC, [RECOGNITION_DATE] ASC, [NTRANCATG] ASC, [IEXTLREF] ASC) WITH (FILLFACTOR = 90)
);
