CREATE TABLE [dbo].[T_MASTER_SEC_ANALYTIC] (
    ...
    [CADIS_SYSTEM_INSERTED]            DATETIME        CONSTRAINT [DF__T_MASTER___CADIS__745AE5AF] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_UPDATED]             DATETIME        CONSTRAINT [DF__T_MASTER___CADIS__754F09E8] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_CHANGEDBY]           NVARCHAR (50)   CONSTRAINT [DF__T_MASTER___CADIS__76432E21] DEFAULT ('UNKNOWN') NULL,
    [CADIS_SYSTEM_PRIORITY]            INT             CONSTRAINT [DF__T_MASTER___CADIS__7737525A] DEFAULT ((1)) NULL,
    [CADIS_SYSTEM_LASTMODIFIED]        DATETIME        CONSTRAINT [DF__T_MASTER___CADIS__782B7693] DEFAULT (getdate()) NULL,
    CONSTRAINT [PK__T_MASTER__B157E8F2FAB03919] PRIMARY KEY CLUSTERED ([EDM_SEC_ID] ASC) WITH (FILLFACTOR = 90)
);
