CREATE TABLE [dbo].[T_NT_DEALS_IN_PROGRESS] (
    ...
    [DEALING_PERIOD_ID]           INT             NOT NULL,
    ...
    [CADIS_SYSTEM_INSERTED]       DATETIME        CONSTRAINT [DF__T_NT_DEAL__CADIS__4FA0C451] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_UPDATED]        DATETIME        CONSTRAINT [DF__T_NT_DEAL__CADIS__5094E88A] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_CHANGEDBY]      NVARCHAR (50)   CONSTRAINT [DF__T_NT_DEAL__CADIS__51890CC3] DEFAULT ('UNKOWN') NULL,
    [CADIS_SYSTEM_PRIORITY]       INT             CONSTRAINT [DF__T_NT_DEAL__CADIS__527D30FC] DEFAULT ((1)) NULL,
    CONSTRAINT [PK__T_NT_DEA__ABD757BB86007E6A] PRIMARY KEY CLUSTERED ([ASSET] ASC, [ORDER_REF] ASC) WITH (FILLFACTOR = 90)
);
