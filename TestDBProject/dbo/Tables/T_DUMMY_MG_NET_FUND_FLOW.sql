CREATE TABLE [dbo].[T_DUMMY_MG_NET_FUND_FLOW] (
    ...
    [CADIS_SYSTEM_INSERTED]                         DATETIME        CONSTRAINT [DF__T_DUMMY_M__CADIS__528CE1FE] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_UPDATED]                          DATETIME        CONSTRAINT [DF__T_DUMMY_M__CADIS__53810637] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_CHANGEDBY]                        NVARCHAR (50)   CONSTRAINT [DF__T_DUMMY_M__CADIS__54752A70] DEFAULT ('UNKNOWN') NULL,
    [CADIS_SYSTEM_PRIORITY]                         INT             CONSTRAINT [DF__T_DUMMY_M__CADIS__55694EA9] DEFAULT ((1)) NULL,
    [CADIS_SYSTEM_LASTMODIFIED]                     DATETIME        CONSTRAINT [DF__T_DUMMY_M__CADIS__565D72E2] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_TIMESTAMP]                        ROWVERSION      NOT NULL,
    CONSTRAINT [PK__T_DUMMY___46233BEE105F92F7] PRIMARY KEY CLUSTERED ([ACCOUNT_NUMBER] ASC, [TNARRLONG] ASC, [NET_AMOUNT__BASE] ASC, [RECOGNITION_DATE] ASC, [NTRANCATG] ASC, [IEXTLREF] ASC) WITH (FILLFACTOR = 90)
);
