CREATE TABLE [dbo].[T_TCA_ITG_RESPONSE_ALLOCATIONS] (
    ...
    CONSTRAINT [pk_T_TCA_ITG_RESPONSE_ALLOCATIONS] PRIMARY KEY CLUSTERED ([ORDERID] ASC, [TRADE_DATE_TIME] ASC, [ACCOUNT] ASC, [TRADE_SHARES] ASC)
);
