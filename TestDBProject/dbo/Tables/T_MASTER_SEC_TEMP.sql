CREATE TABLE [dbo].[T_MASTER_SEC_TEMP] (
    ...
    [INCORPORATION_ISO_CTY]          VARCHAR (2)   NULL,
    [DOMICILE_ISO_CTY]               VARCHAR (2)   NULL,
    [ISSUE_COUNTRY_ISO]              VARCHAR (2)   NULL,
    [RISK_ISO_CTY]                   VARCHAR (2)   NULL,
    ...
    [PRIMARY_EXCHANGE_NAME]          VARCHAR (20)  NULL,
    PRIMARY KEY CLUSTERED ([EDM_SEC_ID] ASC) WITH (FILLFACTOR = 90)
);
