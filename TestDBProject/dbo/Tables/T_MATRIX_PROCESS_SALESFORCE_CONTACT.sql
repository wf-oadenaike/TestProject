CREATE TABLE [dbo].[T_MATRIX_PROCESS_SALESFORCE_CONTACT] (
    ...
    [CADIS_SYSTEM_INSERTED]     DATETIME       CONSTRAINT [DF_T_MATRIX_PROCESS_SALESFORCE_CONTACT_CSI] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_UPDATED]      DATETIME       CONSTRAINT [DF_T_MATRIX_PROCESS_SALESFORCE_CONTACT_CSU] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_CHANGEDBY]    VARCHAR (50)   CONSTRAINT [DF_T_MATRIX_PROCESS_SALESFORCE_CONTACT_CSCB] DEFAULT ('UNKNOWN') NULL,
    [CADIS_SYSTEM_PRIORITY]     INT            CONSTRAINT [DF_T_MATRIX_PROCESS_SALESFORCE_CONTACT_CSP] DEFAULT ((1)) NULL,
    [CADIS_SYSTEM_TIMESTAMP]    ROWVERSION     NOT NULL,
    [CADIS_SYSTEM_LASTMODIFIED] DATETIME       CONSTRAINT [DF_T_MATRIX_PROCESS_SALESFORCE_CONTACT_CSL] DEFAULT (getdate()) NULL,
    CONSTRAINT [PK__T_MATRIX_PROCESS_SALESFORCE_CONTACT] PRIMARY KEY CLUSTERED ([CntSivId] ASC, [AsAtDate] ASC, [CaseID] ASC) WITH (FILLFACTOR = 90)
);
