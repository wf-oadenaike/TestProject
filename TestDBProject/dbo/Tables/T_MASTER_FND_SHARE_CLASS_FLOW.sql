CREATE TABLE [dbo].[T_MASTER_FND_SHARE_CLASS_FLOW] (
    ...
    [CADIS_SYSTEM_INSERTED]     DATETIME        CONSTRAINT [DF__T_MASTER___CADIS__4385D186] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_UPDATED]      DATETIME        CONSTRAINT [DF__T_MASTER___CADIS__4479F5BF] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_CHANGEDBY]    NVARCHAR (50)   CONSTRAINT [DF__T_MASTER___CADIS__456E19F8] DEFAULT ('UNKNOWN') NULL,
    [CADIS_SYSTEM_PRIORITY]     INT             CONSTRAINT [DF__T_MASTER___CADIS__46623E31] DEFAULT ((1)) NULL,
    [CADIS_SYSTEM_LASTMODIFIED] DATETIME        CONSTRAINT [DF__T_MASTER___CADIS__4756626A] DEFAULT (getdate()) NULL,
    CONSTRAINT [PK__T_MASTER__5128527D28FFF846] PRIMARY KEY CLUSTERED ([VALUATION_POINT_DATE] ASC, [EXTERNAL_FUND_CODE] ASC, [FUND_REFERENCE] ASC) WITH (FILLFACTOR = 90)
);
