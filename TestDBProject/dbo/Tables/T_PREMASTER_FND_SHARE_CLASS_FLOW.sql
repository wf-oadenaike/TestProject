CREATE TABLE [dbo].[T_PREMASTER_FND_SHARE_CLASS_FLOW] (
    ...
    [CADIS_SYSTEM_INSERTED]     DATETIME        CONSTRAINT [DF__T_PREMAST__CADIS__4E035FF9] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_UPDATED]      DATETIME        CONSTRAINT [DF__T_PREMAST__CADIS__4EF78432] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_CHANGEDBY]    NVARCHAR (50)   CONSTRAINT [DF__T_PREMAST__CADIS__4FEBA86B] DEFAULT ('UNKNOWN') NULL,
    [CADIS_SYSTEM_PRIORITY]     INT             CONSTRAINT [DF__T_PREMAST__CADIS__50DFCCA4] DEFAULT ((1)) NULL,
    [CADIS_SYSTEM_LASTMODIFIED] DATETIME        CONSTRAINT [DF__T_PREMAST__CADIS__51D3F0DD] DEFAULT (getdate()) NULL,
    CONSTRAINT [PK__T_PREMAS__5128527DFFC5E2CF] PRIMARY KEY CLUSTERED ([VALUATION_POINT_DATE] ASC, [EXTERNAL_FUND_CODE] ASC, [FUND_REFERENCE] ASC) WITH (FILLFACTOR = 90)
);
