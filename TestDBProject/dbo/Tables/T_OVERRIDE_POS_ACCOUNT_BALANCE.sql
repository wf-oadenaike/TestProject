CREATE TABLE [dbo].[T_OVERRIDE_POS_ACCOUNT_BALANCE] (
    ...
    PRIMARY KEY CLUSTERED ([FUND_SHORT_NAME] ASC, [POSITION_DATE] ASC, [ASSET_SUB_CATEGORY] ASC, [CCY] ASC) WITH (FILLFACTOR = 90)
);
