CREATE VIEW "CADIS"."ILT_SLA_Process_Monitor_FieldLinks" AS 
...
join CADIS_SYS.VW_ALL_PROCESSES tp on tp.GUID='3d9e306303f14fcdaa63bff1f25fb101' AND tp.IDENTIFIER = t.TEMPLATEID and tp.COMPONENTID=7
...
FOR flds.illName IN ([SLA Param],[SLA Process Monitor],[SLA Process Monitor View])
