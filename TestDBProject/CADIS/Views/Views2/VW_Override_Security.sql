CREATE VIEW "CADIS"."VW_Override_Security"
AS
SELECT
...
,T2.[DIVIDEND_CCY]
FROM
"dbo"."T_OVERRIDE_SEC" T1
LEFT JOIN "dbo"."T_OVERRIDE_SEC_EQUITY" T2 ON T1.[EDM_SEC_ID] = T2.[EDM_SEC_ID] 
LEFT JOIN "dbo"."T_OVERRIDE_SEC_FIXED" T3 ON T1.[EDM_SEC_ID] = T3.[EDM_SEC_ID] 
LEFT JOIN "dbo"."T_OVERRIDE_SEC_DERIVATIVE" T4 ON T1.[EDM_SEC_ID] = T4.[EDM_SEC_ID] 
LEFT JOIN "dbo"."T_OVERRIDE_SEC_ANALYTIC" T5 ON T1.[EDM_SEC_ID] = T5.[EDM_SEC_ID] 
