CREATE VIEW "CADIS"."ILT_Fact_FieldLinks" AS 
...
join CADIS_SYS.VW_ALL_PROCESSES tp on tp.GUID='0c4adae34e2640e6b639b97582b22af4' AND tp.IDENTIFIER = t.TEMPLATEID and tp.COMPONENTID=7
...
FOR flds.illName IN ([Fact Financials Fact],[Fact KPIFact])
