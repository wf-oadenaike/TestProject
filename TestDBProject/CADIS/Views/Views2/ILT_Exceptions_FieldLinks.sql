CREATE VIEW "CADIS"."ILT_Exceptions_FieldLinks" AS 
...
join CADIS_SYS.VW_ALL_PROCESSES tp on tp.GUID='3a1b8eda29784e3a9def28bacd14bc1d' AND tp.IDENTIFIER = t.TEMPLATEID and tp.COMPONENTID=7
...
FOR flds.illName IN ([Exception Data Load])
