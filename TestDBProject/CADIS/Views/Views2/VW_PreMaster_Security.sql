CREATE VIEW "CADIS"."VW_PreMaster_Security"
AS
SELECT
...
,T2.[DIVIDEND_CCY]
FROM
"dbo"."T_PREMASTER_SEC" T1
LEFT JOIN "dbo"."T_PREMASTER_SEC_EQUITY" T2 ON T1.[EDM_SEC_ID] = T2.[EDM_SEC_ID] 
LEFT JOIN "dbo"."T_PREMASTER_SEC_FIXED" T3 ON T1.[EDM_SEC_ID] = T3.[EDM_SEC_ID] 
LEFT JOIN "dbo"."T_PREMASTER_SEC_DERIVATIVE" T4 ON T1.[EDM_SEC_ID] = T4.[EDM_SEC_ID] 
LEFT JOIN "dbo"."T_PREMASTER_SEC_ANALYTIC" T5 ON T1.[EDM_SEC_ID] = T5.[EDM_SEC_ID] 
