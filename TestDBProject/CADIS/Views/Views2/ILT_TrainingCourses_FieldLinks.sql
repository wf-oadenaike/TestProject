CREATE VIEW "CADIS"."ILT_TrainingCourses_FieldLinks" AS 
...
join CADIS_SYS.VW_ALL_PROCESSES tp on tp.GUID='155ba6f60a704fa1ae6995e9fc80699c' AND tp.IDENTIFIER = t.TEMPLATEID and tp.COMPONENTID=7
...
FOR flds.illName IN ([TrainingCourses])
