CREATE VIEW "CADIS"."ILT_Unquoted_FieldLinks" AS 
...
join CADIS_SYS.VW_ALL_PROCESSES tp on tp.GUID='b54871af4d904374b7b9adb2a18dc13a' AND tp.IDENTIFIER = t.TEMPLATEID and tp.COMPONENTID=7
...
FOR flds.illName IN ([Unquoted Investment Allocation],[Unquoted Investment Funding],[Unquoted Investment New Issuer],[Unquoted Investment Revaluation])
