CREATE VIEW "CADIS"."ILT_Subscriber_FieldLinks" AS 
...
join CADIS_SYS.VW_ALL_PROCESSES tp on tp.GUID='78633b72d58842b79e3c085402184bd3' AND tp.IDENTIFIER = t.TEMPLATEID and tp.COMPONENTID=7
...
FOR flds.illName IN ([Subscriber])
