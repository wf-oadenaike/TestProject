CREATE VIEW "CADIS"."ILT_Fund_Quarterly_Income_FieldLinks" AS 
...
join CADIS_SYS.VW_ALL_PROCESSES tp on tp.GUID='8da3b3ec20654f379a1d1295b874c72e' AND tp.IDENTIFIER = t.TEMPLATEID and tp.COMPONENTID=7
...
FOR flds.illName IN ([Fund Quarterly Income])
