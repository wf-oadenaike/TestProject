CREATE VIEW "CADIS"."ILT_Reference_Base_FieldLinks" AS 
...
join CADIS_SYS.VW_ALL_PROCESSES tp on tp.GUID='c839b926cd61410f940799e0bf8a70ed' AND tp.IDENTIFIER = t.TEMPLATEID and tp.COMPONENTID=7
...
FOR flds.illName IN ([Reference Data Lookup])
