CREATE VIEW "CADIS"."ILT_FX_Rate_FieldLinks" AS 
...
join CADIS_SYS.VW_ALL_PROCESSES tp on tp.GUID='3fec18c7956648ca837cdda409cfd065' AND tp.IDENTIFIER = t.TEMPLATEID and tp.COMPONENTID=7
...
FOR flds.illName IN ([Master FX Rate],[Override FX Rate],[PreMaster FX Rate],[Previous FX Rate])
