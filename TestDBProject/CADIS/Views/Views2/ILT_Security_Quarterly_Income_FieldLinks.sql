CREATE VIEW "CADIS"."ILT_Security_Quarterly_Income_FieldLinks" AS 
...
join CADIS_SYS.VW_ALL_PROCESSES tp on tp.GUID='267ba780490a4a8ead06700474258ee5' AND tp.IDENTIFIER = t.TEMPLATEID and tp.COMPONENTID=7
...
FOR flds.illName IN ([Override Security Quarterly Income],[Security Quarterly Income])
