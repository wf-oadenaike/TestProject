CREATE VIEW "CADIS"."ILT_Dividend_Forecast_FieldLinks" AS 
...
join CADIS_SYS.VW_ALL_PROCESSES tp on tp.GUID='de8f3f810f69424786de08d086d0e33b' AND tp.IDENTIFIER = t.TEMPLATEID and tp.COMPONENTID=7
...
FOR flds.illName IN ([BBG Dividend Forecast],[Master Dividend Forecast],[Override Dividend Forecast])
