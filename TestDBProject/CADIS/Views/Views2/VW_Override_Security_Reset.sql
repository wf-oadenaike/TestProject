CREATE VIEW "CADIS"."VW_Override_Security_Reset"
AS
SELECT
...
,T2.[DIVIDEND_CCY]
FROM
"dbo"."T_OVERRIDE_SEC_RESET" T1
LEFT JOIN "dbo"."T_OVERRIDE_SEC_EQUITY_RESET" T2 ON T1.[EDM_SEC_ID] = T2.[EDM_SEC_ID] 
LEFT JOIN "dbo"."T_OVERRIDE_SEC_FIXED_RESET" T3 ON T1.[EDM_SEC_ID] = T3.[EDM_SEC_ID] 
LEFT JOIN "dbo"."T_OVERRIDE_SEC_DERIVATIVE_RESET" T4 ON T1.[EDM_SEC_ID] = T4.[EDM_SEC_ID] 
LEFT JOIN "dbo"."T_OVERRIDE_SEC_ANALYTIC_RESET" T5 ON T1.[EDM_SEC_ID] = T5.[EDM_SEC_ID] 
