CREATE VIEW "CADIS"."ILT_PolicyProcedureDocument_FieldLinks" AS 
...
join CADIS_SYS.VW_ALL_PROCESSES tp on tp.GUID='75a1fb9320ac4366bfb027b7ca4b892d' AND tp.IDENTIFIER = t.TEMPLATEID and tp.COMPONENTID=7
...
FOR flds.illName IN ([PolicyProc Maintenance],[PolicyProcDocumentReviewOverDueVw])
