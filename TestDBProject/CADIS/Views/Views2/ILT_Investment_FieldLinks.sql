CREATE VIEW "CADIS"."ILT_Investment_FieldLinks" AS 
...
join CADIS_SYS.VW_ALL_PROCESSES tp on tp.GUID='cefd3e35388c493dbb91d30c1e8e2b72' AND tp.IDENTIFIER = t.TEMPLATEID and tp.COMPONENTID=7
...
FOR flds.illName IN ([Investment FinPro Events],[Investment FinProms Register],[Investment Research Broker Budget Changes],[Investment Research Broker Register])
