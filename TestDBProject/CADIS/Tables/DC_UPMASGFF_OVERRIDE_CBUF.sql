CREATE TABLE [CADIS].[DC_UPMASGFF_OVERRIDE_CBUF] (
...
GO
CREATE NONCLUSTERED INDEX [IX_CADIS_SYSTEM_RUNID83]
    ON [CADIS].[DC_UPMASGFF_OVERRIDE_CBUF]([CADIS_SYSTEM_RUNID] ASC);
