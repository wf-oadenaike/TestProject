CREATE TABLE [CADIS].[DC_UPMASNFF_OVERRIDE_CBUF] (
...
GO
CREATE NONCLUSTERED INDEX [IX_CADIS_SYSTEM_RUNID71]
    ON [CADIS].[DC_UPMASNFF_OVERRIDE_CBUF]([CADIS_SYSTEM_RUNID] ASC);
