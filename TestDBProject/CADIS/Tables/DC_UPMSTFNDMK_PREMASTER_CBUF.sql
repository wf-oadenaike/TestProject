CREATE TABLE [CADIS].[DC_UPMSTFNDMK_PREMASTER_CBUF] (
...
GO
CREATE NONCLUSTERED INDEX [IX_CADIS_SYSTEM_RUNID31]
    ON [CADIS].[DC_UPMSTFNDMK_PREMASTER_CBUF]([CADIS_SYSTEM_RUNID] ASC);
