CREATE TABLE [CADIS].[DC_UPPREMSTIN_NT_CBUF] (
...
GO
CREATE NONCLUSTERED INDEX [IX_CADIS_SYSTEM_RUNID234]
    ON [CADIS].[DC_UPPREMSTIN_NT_CBUF]([CADIS_SYSTEM_RUNID] ASC) WITH (FILLFACTOR = 80);
