CREATE TABLE [CADIS].[DC_UPMSTPOS_PREMASTER_CBUF] (
...
GO
CREATE NONCLUSTERED INDEX [IX_CADIS_SYSTEM_RUNID41]
    ON [CADIS].[DC_UPMSTPOS_PREMASTER_CBUF]([CADIS_SYSTEM_RUNID] ASC);
