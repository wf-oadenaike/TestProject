CREATE TABLE [CADIS].[DC_UPMSTFNDMK_OVERRIDE_CBUF] (
...
GO
CREATE NONCLUSTERED INDEX [IX_CADIS_SYSTEM_RUNID32]
    ON [CADIS].[DC_UPMSTFNDMK_OVERRIDE_CBUF]([CADIS_SYSTEM_RUNID] ASC);
