CREATE TABLE [CADIS].[DC_UPMSTFNDMK_EXPIRY_CBUF] (
...
GO
CREATE NONCLUSTERED INDEX [IX_CADIS_SYSTEM_RUNID117]
    ON [CADIS].[DC_UPMSTFNDMK_EXPIRY_CBUF]([CADIS_SYSTEM_RUNID] ASC);
