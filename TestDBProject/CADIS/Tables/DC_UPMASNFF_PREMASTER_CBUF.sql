CREATE TABLE [CADIS].[DC_UPMASNFF_PREMASTER_CBUF] (
...
GO
CREATE NONCLUSTERED INDEX [IX_CADIS_SYSTEM_RUNID70]
    ON [CADIS].[DC_UPMASNFF_PREMASTER_CBUF]([CADIS_SYSTEM_RUNID] ASC);
