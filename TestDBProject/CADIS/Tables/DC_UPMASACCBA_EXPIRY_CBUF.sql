CREATE TABLE [CADIS].[DC_UPMASACCBA_EXPIRY_CBUF] (
...
GO
CREATE NONCLUSTERED INDEX [IX_CADIS_SYSTEM_RUNID115]
    ON [CADIS].[DC_UPMASACCBA_EXPIRY_CBUF]([CADIS_SYSTEM_RUNID] ASC);
