CREATE TABLE [CADIS].[DC_UPMASGFF_PREMASTER_CBUF] (
...
GO
CREATE NONCLUSTERED INDEX [IX_CADIS_SYSTEM_RUNID82]
    ON [CADIS].[DC_UPMASGFF_PREMASTER_CBUF]([CADIS_SYSTEM_RUNID] ASC);
