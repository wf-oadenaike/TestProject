CREATE TABLE [CADIS].[DC_UPMASACCBA_OVERRIDE_CBUF] (
...
GO
CREATE NONCLUSTERED INDEX [IX_CADIS_SYSTEM_RUNID76]
    ON [CADIS].[DC_UPMASACCBA_OVERRIDE_CBUF]([CADIS_SYSTEM_RUNID] ASC);
