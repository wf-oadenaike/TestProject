CREATE TABLE [CADIS].[DC_UPMASCFLOW_EXPIRY_CBUF] (
...
GO
CREATE NONCLUSTERED INDEX [IX_CADIS_SYSTEM_RUNID125]
    ON [CADIS].[DC_UPMASCFLOW_EXPIRY_CBUF]([CADIS_SYSTEM_RUNID] ASC);
