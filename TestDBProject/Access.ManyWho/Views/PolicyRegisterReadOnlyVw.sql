...
CREATE VIEW  [Access.ManyWho].[PolicyRegisterReadOnlyVw]

AS

-------------------------------------------------------------------------------------- 
-- Name: [Access.ManyWho].[PolicyRegisterReadOnlyVw]
-- 
-------------------------------------------------------------------------------------- 
...
SELECT pr.PolicyId
		 ...
		 ,Cast(CASE WHEN PolicyName like'%Business Continuity Plan%' THEN 1
	        ELSE 0
	   END  as bit) as IsBCP
