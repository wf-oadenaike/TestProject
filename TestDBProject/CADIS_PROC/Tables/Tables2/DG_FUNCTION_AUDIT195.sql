CREATE TABLE [CADIS_PROC].[DG_FUNCTION_AUDIT195] (
    ...
    CONSTRAINT [PK_DG_FUNCTION_AUDIT195] PRIMARY KEY CLUSTERED ([ID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IDXAUDITDATE]
    ON [CADIS_PROC].[DG_FUNCTION_AUDIT195]([INSERTED] ASC);
