CREATE TABLE [CADIS_PROC].[DG_FUNCTION_AUDIT206] (
    ...
    CONSTRAINT [PK_DG_FUNCTION_AUDIT206] PRIMARY KEY CLUSTERED ([ID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IDXAUDITDATE]
    ON [CADIS_PROC].[DG_FUNCTION_AUDIT206]([INSERTED] ASC);
