CREATE TABLE [CADIS_PROC].[DG_FUNCTION_AUDIT192] (
    ...
    CONSTRAINT [PK_DG_FUNCTION_AUDIT192] PRIMARY KEY CLUSTERED ([ID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IDXAUDITDATE]
    ON [CADIS_PROC].[DG_FUNCTION_AUDIT192]([INSERTED] ASC);
