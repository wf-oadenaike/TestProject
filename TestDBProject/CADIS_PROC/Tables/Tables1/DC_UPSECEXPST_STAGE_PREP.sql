CREATE TABLE [CADIS_PROC].[DC_UPSECEXPST_STAGE_PREP] (
    ...
    PRIMARY KEY CLUSTERED ([SOURCE_TABLE] ASC, [SOURCE_KEY] ASC, [SOURCE_COLUMN] ASC, [EXCEPTION_CODE] ASC, [SOURCE_DATE] ASC) WITH (FILLFACTOR = 80)
);
