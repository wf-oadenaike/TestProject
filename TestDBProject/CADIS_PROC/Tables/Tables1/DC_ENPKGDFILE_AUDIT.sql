CREATE TABLE [CADIS_PROC].[DC_ENPKGDFILE_AUDIT] (
    ...
    PRIMARY KEY CLUSTERED ([TOPLEVELRUNID] ASC, [CADIS_SYSTEM_RUNID] ASC, [CADIS_SYSTEM_FIELDNAME] ASC) WITH (FILLFACTOR = 80)
);
