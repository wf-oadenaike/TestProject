CREATE TABLE [CADIS_PROC].[DC_PREMASSEC_BPS_PREP] (
    [EDM_SEC_ID]                     INT          NOT NULL,
    [FILE_NAME]                      VARCHAR (50) NULL,
    [DATE]                           DATE         NULL,
    [IDENTIFIER]                     VARCHAR (50) NULL,
    [SECURITY_NAME]                  VARCHAR (50) NULL,
    [SECURITY_DESCRIPTION]           VARCHAR (50) NULL,
    [SECURITY_SHORTNAME]             VARCHAR (50) NULL,
    ...
    [SECURITY_ISO_CCY]               VARCHAR (50) NULL,
    ...
    [PARSEKEYABLE_DESCRIPTION]       VARCHAR (50) NULL,
    ...
    [VOLUME_AVG_5D]                  VARCHAR (50) NULL,
    [VOLUME_AVG_20D]                 VARCHAR (50) NULL,
    [ADV_TOTAL_VOLUME]               VARCHAR (50) NULL,
