CREATE TABLE [CADIS_PROC].[DC_PMFFLOW_OMNISFF_PREP] (
    ...
    PRIMARY KEY CLUSTERED ([FUND] ASC, [TRANSACTION_DATE] ASC, [FUND_FLOW_TYPE] ASC, [FLOW_TYPE] ASC) WITH (FILLFACTOR = 80)
);
