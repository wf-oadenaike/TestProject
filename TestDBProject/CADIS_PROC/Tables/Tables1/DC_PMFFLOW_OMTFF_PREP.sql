CREATE TABLE [CADIS_PROC].[DC_PMFFLOW_OMTFF_PREP] (
    ...
    PRIMARY KEY CLUSTERED ([FUND] ASC, [TRANSACTION_DATE] ASC, [CURRENCY] ASC, [FUND_FLOW_TYPE] ASC, [FLOW_TYPE] ASC, [SOURCE_TYPE] ASC) WITH (FILLFACTOR = 80)
);
