CREATE TABLE [CADIS_PROC].[DC_UPMSTDVDFC_INFO_RUNID] (
    ...
    [Q1Income__RUNID]       INT          NOT NULL,
    [Q1ToPay__RUNID]        INT          NOT NULL,
    [Q2ExDate__RUNID]       INT          NOT NULL,
    [Q2Rate__RUNID]         INT          NOT NULL,
    [Q2Income__RUNID]       INT          NOT NULL,
    [Q2ToPay__RUNID]        INT          NOT NULL,
    [Q3ExDate__RUNID]       INT          NOT NULL,
    [Q3Rate__RUNID]         INT          NOT NULL,
    [Q3Income__RUNID]       INT          NOT NULL,
    [Q3ToPay__RUNID]        INT          NOT NULL,
    [Q4ExDate__RUNID]       INT          NOT NULL,
    [Q4Rate__RUNID]         INT          NOT NULL,
    [Q4Income__RUNID]       INT          NOT NULL,
    [Q4ToPay__RUNID]        INT          NOT NULL,
