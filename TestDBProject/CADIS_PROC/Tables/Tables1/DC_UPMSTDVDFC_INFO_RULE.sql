CREATE TABLE [CADIS_PROC].[DC_UPMSTDVDFC_INFO_RULE] (
    ...
    [Q1Income__RULEID]       INT          NULL,
    [Q1ToPay__RULEID]        INT          NULL,
    [Q2ExDate__RULEID]       INT          NULL,
    [Q2Rate__RULEID]         INT          NULL,
    [Q2Income__RULEID]       INT          NULL,
    [Q2ToPay__RULEID]        INT          NULL,
    [Q3ExDate__RULEID]       INT          NULL,
    [Q3Rate__RULEID]         INT          NULL,
    [Q3Income__RULEID]       INT          NULL,
    [Q3ToPay__RULEID]        INT          NULL,
    [Q4ExDate__RULEID]       INT          NULL,
    [Q4Rate__RULEID]         INT          NULL,
    [Q4Income__RULEID]       INT          NULL,
    [Q4ToPay__RULEID]        INT          NULL,
