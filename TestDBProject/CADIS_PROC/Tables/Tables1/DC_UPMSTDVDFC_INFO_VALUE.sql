CREATE TABLE [CADIS_PROC].[DC_UPMSTDVDFC_INFO_VALUE] (
    ...
    [Q1Income]               DECIMAL (24, 10) NULL,
    [Q1ToPay]                DECIMAL (24, 10) NULL,
    [Q2ExDate]               DATETIME         NULL,
    [Q2Rate]                 DECIMAL (20, 6)  NULL,
    [Q2Income]               DECIMAL (24, 10) NULL,
    [Q2ToPay]                DECIMAL (24, 10) NULL,
    [Q3ExDate]               DATETIME         NULL,
    [Q3Rate]                 DECIMAL (20, 6)  NULL,
    [Q3Income]               DECIMAL (24, 10) NULL,
    [Q3ToPay]                DECIMAL (24, 10) NULL,
    [Q4ExDate]               DATETIME         NULL,
    [Q4Rate]                 DECIMAL (20, 6)  NULL,
    [Q4Income]               DECIMAL (24, 10) NULL,
    [Q4ToPay]                DECIMAL (24, 10) NULL,
