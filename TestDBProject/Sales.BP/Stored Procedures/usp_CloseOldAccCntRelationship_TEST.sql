--set nocount on
--drop procedure [Sales.BP].usp_CloseOldAccCntRelationship_TEST 
--go

CREATE procedure [Sales.BP].usp_CloseOldAccCntRelationship_TEST as
begin

    declare @n int

    -- Christopher Johnson has left Ayton Law
...
(
    N'CXJ00027',
    N'0032000001BtgMVAAZ',
    N'$EKY9',
    N'con15979#323031342D30332D3238',
    N'Mr',
    N'Christopher',
    N'Johnson',
    N'Mr',
    ...
    NULL,
    N'01642 659600',
    N'chris.ayton-law@ntlbusiness.com',
    1,
    0,
    0,
    0,
    ...
    NULL,
    NULL,
    CAST(N'2016-09-15 15:12:55.057' AS DateTime),
    CAST(N'2016-09-15 15:12:55.057' AS DateTime),
    N'UNKNOWN',
    1,
    CAST(N'2016-09-15 15:12:55.057' AS DateTime)
    ...
    where       wa.AccName  = 'Ayton-Law Ltd'
    and         wc.CntFcaId = 'CXJ00027'
    ...
    (
        ...
        (
            ...
            and         wa.AccName                          in ( 'Acklam Financial Ltd', 'Ayton-Law Ltd' )
            intersect
            (
                select 'Acklam Financial Ltd', 'JTS00002', 0, 1, 2 union
                select 'Ayton-Law Ltd'       , 'CXJ00027', 0, 0, 2
            )
        ) x
    ...
    exec [Sales.BP].usp_CloseOldAccCntRelationship @YYYYMMDD_hhmm, Y -- salesforce data, no confirm
    ...
    (
        ...
        (
            ...
            intersect
            (
                select 'Acklam Financial Ltd', 'JTS00002', 0, 0, 2 union
                select 'Ayton-Law Ltd'       , 'CXJ00027', 0, 0, 2
            )
        ) x
...
--go
--exec [Sales.BP].usp_CloseOldAccCntRelationship_TEST 
--go
