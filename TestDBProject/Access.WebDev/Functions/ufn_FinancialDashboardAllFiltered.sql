...
CREATE FUNCTION [Access.WebDev].[ufn_FinancialDashboardAllFiltered]
(
...
AS
-------------------------------------------------------------------------------------- 
-- Name: [Access.WebDev].[ufn_FinancialDashboardAllFiltered]
-- 
-- Params:	@FinancialYear INT - Financial Year for which the function is to be run for.
-------------------------------------------------------------------------------------- 
-- History:
-- Olu :02/05/2018 JIRA: Clone of [ufn_FinancialDashboardAll] with Filters 
-------------------------------------------------------------------------------------- 
