CREATE TABLE [Access.WebDev].[FinancialDashboard_2015_TO_2016] (
    ...
    CONSTRAINT [pk_FinancialDashboard_2015_TO_2016] PRIMARY KEY CLUSTERED ([FinancialFactId] ASC) WITH (FILLFACTOR = 80)
);
