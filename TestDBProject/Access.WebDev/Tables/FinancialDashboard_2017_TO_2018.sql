CREATE TABLE [Access.WebDev].[FinancialDashboard_2017_TO_2018] (
    ...
    CONSTRAINT [pk_FinancialDashboard_2017_TO_2018] PRIMARY KEY CLUSTERED ([FinancialFactId] ASC) WITH (FILLFACTOR = 80)
);
