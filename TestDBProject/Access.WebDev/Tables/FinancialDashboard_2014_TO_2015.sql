CREATE TABLE [Access.WebDev].[FinancialDashboard_2014_TO_2015] (
    ...
    CONSTRAINT [pk_FinancialDashboard_2014_TO_2015] PRIMARY KEY CLUSTERED ([FinancialFactId] ASC) WITH (FILLFACTOR = 80)
);
