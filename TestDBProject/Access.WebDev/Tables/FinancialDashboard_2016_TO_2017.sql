CREATE TABLE [Access.WebDev].[FinancialDashboard_2016_TO_2017] (
    ...
    CONSTRAINT [pk_FinancialDashboard_2016_TO_2017] PRIMARY KEY CLUSTERED ([FinancialFactId] ASC) WITH (FILLFACTOR = 80)
);
