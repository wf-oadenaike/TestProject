CREATE TABLE [Staging].[Matrix_ReRegistration] (
    ...
    [REREGISTRATION_GROUP_ID]          INT            NULL,
    [FILE_NAME]                        VARCHAR (100)  NOT NULL,
    [FILE_DATE]                        DATETIME       NOT NULL,
    [FILE_TYPE]                        VARCHAR (20)   NOT NULL,
    [CADIS_SYSTEM_INSERTED]            DATETIME       CONSTRAINT [DF_staging_Matrix_ReRegistration_CSI] DEFAULT (getdate()) NOT NULL,
    [CADIS_SYSTEM_UPDATED]             DATETIME       CONSTRAINT [DF_staging_Matrix_ReRegistration_CSU] DEFAULT (getdate()) NULL,
    [CADIS_SYSTEM_CHANGEDBY]           VARCHAR (50)   CONSTRAINT [DF_staging_Matrix_ReRegistration_CSCB] DEFAULT ('UNKNOWN') NULL,
    [CADIS_SYSTEM_PRIORITY]            INT            CONSTRAINT [DF_staging_Matrix_ReRegistration_CSP] DEFAULT ((1)) NULL,
    [CADIS_SYSTEM_TIMESTAMP]           ROWVERSION     NOT NULL,
    [CADIS_SYSTEM_LASTMODIFIED]        DATETIME       CONSTRAINT [DF_staging_Matrix_ReRegistration_CSL] DEFAULT (getdate()) NULL,
    CONSTRAINT [PK__staging_Matrix_ReRegistration] PRIMARY KEY CLUSTERED ([SALESFORCE_ACCOUNT_ID] ASC, [MX_MATRIX_ACCOUNT_SIV_ID] ASC, [AS_AT_DATE] ASC) WITH (FILLFACTOR = 90)
);
