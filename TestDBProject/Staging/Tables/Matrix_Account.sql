CREATE TABLE [Staging].[Matrix_Account] (
    ...
    CONSTRAINT [PK__staging_Matrix_Account] PRIMARY KEY CLUSTERED ([MX_MATRIX_ACCOUNT_SIV_ID] ASC, [AS_AT_DATE] ASC) WITH (FILLFACTOR = 90)
);
