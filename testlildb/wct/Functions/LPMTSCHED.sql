...
(@PV FLOAT (53) NULL, @LoanDate DATETIME NULL, @Pmt FLOAT (53) NULL, @Rate FLOAT (53) NULL, @FirstPayDate DATETIME NULL, @NumPmts INT NULL, @Pmtpyr INT NULL, @DaysInYr INT NULL, @FV FLOAT (53) NULL, @IntRule NVARCHAR (4000) NULL, @Decimals INT NULL, @LastPmtNum INT NULL)
RETURNS 
     TABLE (
        [num_pmt]       INT        NULL,
