...
(@CallPut NVARCHAR (4000) NULL, @BarrierType NVARCHAR (4000) NULL, @AssetPrice FLOAT (53) NULL, @StrikePrice FLOAT (53) NULL, @BarrierPrice FLOAT (53) NULL, @Rebate FLOAT (53) NULL, @TimeToMaturity FLOAT (53) NULL, @RiskFreeRate FLOAT (53) NULL, @DividendRate FLOAT (53) NULL, @Volatility FLOAT (53) NULL)
RETURNS 
     TABLE (
        [Price]              FLOAT (53) NULL,
        [Delta]              FLOAT (53) NULL,
